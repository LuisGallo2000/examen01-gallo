        ...
        .done((data) => {
            ...
            if (data.ok) {
                $.each(data.body, (index, registro) => {
                    ...
                    t.row.add([botonera, registro.id, registro.nombre, registro.descripcion, registro.fechaInicio, registro.fechaFin, registro.costo]);
                });
                t.draw(false);
            } else {
    ...
    ajaxRequest("GET", `${url}/${id}`)
        .done((data) => {
            if (data.ok) {
                ...
                $("#fecha_inicio").val(data.body.fechaInicio);
                $("#fecha_fin").val(data.body.fechaFin);
